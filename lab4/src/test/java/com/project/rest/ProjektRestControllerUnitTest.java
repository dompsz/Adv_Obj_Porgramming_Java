...
public class ProjektRestControllerUnitTest { 
 ...
 void getProject_whenValidId_shouldReturnGivenProject() { 
  Projekt projekt = new Projekt(1, "Nazwa1", "Opis1", null, LocalDate.of(2024, 6, 7)); 
 ...
 void getProjects_shouldReturnPageWithProjects() { 
  List<Projekt> list =  
         List.of(new Projekt(1, "Nazwa1", "Opis1", null, LocalDate.of(2024, 6, 7)), 
          new Projekt(2, "Nazwa2", "Opis2", null, LocalDate.of(2024, 6, 7)), 
          new Projekt(3, "Nazwa3", "Opis3", null, LocalDate.of(2024, 6, 7))); 
